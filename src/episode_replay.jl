...
function EpisodeReplayBuffer(env::AbstractEnv,
                        max_size::Int64,
                        batch_size::Int64,
                        trace_length::Int64,
...
function generate_episode(env::AbstractEnv, action_indices; max_steps::Int64 = 100)
    O = typeof(observe(env))
    episode = DQExperience{Int32, Float32, O}[]
